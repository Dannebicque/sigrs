...
class User implements UserInterface
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Regime::class, inversedBy="users")
     */
    private $regime;

    /**
     * @ORM\OneToMany(targetEntity=ParentEnfant::class, mappedBy="parent")
     */
    ...
    public function removeParentEnfant(ParentEnfant $parentEnfant): self
    {
        if ($this->parentEnfants->removeElement($parentEnfant)) {
            ...
            if ($parentEnfant->getParent() === $this) {
                $parentEnfant->setParent(null);
            }
        }
